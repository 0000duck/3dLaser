...
INCLUDEPATH += \
               $$PWD/include/\
               $$PWD/include/3rdParty/vtk-7.0/\
               #$$PWD/VTK/3rdParty/include/vtk-7.0/\
               $$PWD/3rdParty/Eigen/eigen3/\
               $$PWD/3rdParty/Boost/include/boost-1_61/\
               $$PWD/Qhull/include/\
               $$PWD/FLANN/include/\
               $$PWD/OpenNI2/include/\
               $$PWD/include/3rdParty/pcl-1.8/
...
LIBS += \
        -LD:/vtk/bin/lib/Debug/\
        #-L$$PWD/3rdParty/VTK/lib/\
  -lvtkalglib-7.0-gd\
...
LIBS += -L$$PWD/3rdParty/OpenNI2/Lib/\
    -lOpenNI2
}
else
{
